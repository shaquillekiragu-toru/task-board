				...
				<table class="w100-sm" width="640" cellpadding="0" cellspacing="0" align="center">
					<tr>
						<td class="bg-white pt-3 px-2 pb-3">
							...
							<br />
							<p>
								If you did not initiate this request please contact us at <a href="mailto:<?= \Yii::$app->params['notify']['email']['support-address'] ?>"><?= \Yii::$app->params['notify']['email']['support-address'] ?></a>
							</p>
							<p>
								Yours,
							</p>
