...
class m191011_112044_queue_job extends \yii\db\Migration {

	protected $tableOptions = 'CHARACTER SET utf8 COLLATE utf8_general_ci ENGINE=InnoDB';

	public function safeUp() {
		$this->createTiModelTable('queue_job');
		$this->addColumn('queue_job', 'parent_id', 'INT(11) DEFAULT NULL');
		$this->addColumn('queue_job', 'output', 'LONGTEXT');
	}
